...
namespace webrick_lamar_website {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string username, string firstname, string lastname, string password, string sex) {
...
namespace webrick_lamar_website.DataSet1TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([username], [firstname], [lastname], [password], [sex]" +
                ") VALUES (@username, @firstname, @lastname, @password, @sex)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [username] = @username, [firstname] = @firstname, [lastn" +
                "ame] = @lastname, [password] = @password, [sex] = @sex WHERE (([Id] = @Original_" +
                "Id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, firstname, lastname, password, sex FROM dbo.[Table]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT COUNT(*) FROM [Table] WHERE username=@username";
            ...
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[Table] ([username], [firstname], [lastname], [password], [sex]" +
                ") VALUES (@username, @firstname, @lastname, @password, @sex)";
            ...
            this._commandCollection[3].CommandText = "SELECT COUNT(*) FROM [Table] WHERE (username=@username) and (password=@password)";
        ...
        public virtual int Insert(string username, string firstname, string lastname, string password, string sex) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string firstname, string lastname, string password, string sex, int Original_Id) {
            if ((username == null)) {
        ...
        public virtual int Insert1(string username, string firstname, string lastname, string password, string sex) {
